				...
				<div class="page">
					...
					<div class="content">
						<div class="row">
							...
							<h2>Admin_Mode</h2>
							<form action="newmovie.jsp" method="POST" name = "newmovie">
								<input type="submit" name="new_movie" value = "Upload New Movie">	
							</form>
							<br>
							<br>
							<form action="changemovie.jsp" method="POST" name="changemovie">
								<input type="submit" name="change" value="Modify Movie">
							</form>
