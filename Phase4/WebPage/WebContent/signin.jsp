							...
							<form action="signin_response.jsp" method="POST">
								<div class="contact-form">
									...
									<input type="tel" name="phone"
										...
										<p>Sex : <select name="sex"></p>
										<option value="M" selected>M</option>
										<option value="F">F</option>
									</select> <input type="date" name="bdate" placeholder="Bdate..." required>
									<input type="text" name="job" placeholder="Job..." required> <input
										type="submit" value="Send Message " required>
