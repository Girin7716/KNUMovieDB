						...
						<div class="row">
							...
							<form action="uploadmovie.jsp" method="POST">
								<div class="contact-form">
									...
									<p>
										Actor :<br>
										<p>&nbsp;&nbsp;&nbsp;Actor_Name<input type="text" name="actor_name" placeholder="Actor_Name..."></p>
										<p>&nbsp;&nbsp;&nbsp;Actor's Birth_Year(ex>1997)<input type="number" name="actor_bdate" placeholder="Actor's Birth_Year"></p>
									</p>
