    				...
    				if(Search != ""){
							pstmt = conn.prepareStatement(sql);
 							...
 							{	
 								...
 								sql = "SELECT PARENTGENRETYPE FROM TEMP T, MOVIEIS M WHERE T.TCONST = '" + movie_Tconst + "' AND T.TCONST = M.PARENTTCONST"; 								
 								pstmt = conn.prepareStatement(sql);
 								...
 								sql = "SELECT NAME FROM TEMP T, APPEAR A, ACTOR AC WHERE T.TCONST = '" + movie_Tconst
