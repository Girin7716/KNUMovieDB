				...
				<div class="page">
					...
					<div class="content">
						<div class="row">
							...
							<form action="newmovie2.jsp" method="POST">
								<div class="contact-form">
									...
									<p>
										How many Actor(more than or equal 1) ?
										<input type="number" name="how_many_actor" placeholder="How_many_Actor(number)">
									</p>
									<p>
										How many Version(more than or equal 1)?
										<input type="number" name="how_many_version" placeholder="How_many_Version(number)">
									</p>
