			...
			<div class="container">
				...
				<div class="main-navigation">
					...
					<ul class="menu">
						...
						<li class="menu-item current-menu-item"><a href="signin.jsp">Sign_in</a></li>
					</ul>
					<!-- .menu -->
			...
			<div class="container">
				<div class="page">
					<div class="breadcrumbs">
						<a href="index.html">Home</a> <span>Sign_in</span>
					</div>
					...
					<div class="content">
						<div class="row">
							...
							<h2>Sign_in</h2>
							<form action="signin_response.jsp" method="POST">
								<div class="contact-form">
									...
									<input type="text" name="sex" placeholder="Sex..."> <input
										type="text" name="bdate" placeholder="Bdate..."> <input
										type="text" name="job" placeholder="Job..."> <input
